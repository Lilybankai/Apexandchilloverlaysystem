...
(function () {
  ...
  const ICONS = {
    ...
    // Where the game lives on disk — the Game folder card, and the only place
    // in the panel that is about a path rather than a setting.
    folder:
      '<path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/>',
    // Race reminders, on the Schedule tab. Two states rather than one filled
    // with CSS: a bell that is ON should read as ringing at 14px, and a colour
    // change alone does not survive being glanced at.
    bell:
    ...
    // Schedule tab: the league calendar pulled from SimGrid.
    calendar:
    ...
    // Month navigation on the Schedule calendar.
    ...
    // Settings → Subscription card (v0.69.0).
    'credit-card':
    ...
    /* Setups tab: the symmetric-setup badge (L/R corners chained together). */
    link:
    ...
    /* ---- Streamers tab + stream bot ------------------------------------- */
    video:
      '<path d="m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5"/><rect x="2" y="6" width="14" height="12" rx="2"/>',
    // The chat widget's card icon (it fell back to `monitor` before this).
