  ...
  const STEPS = [
    ...
    },
    {
      ...
      points: [
        ...
        'The other driver’s line is dashed — in the same pedal colours — and the tick boxes beside Pace | Inputs take either line off the map when the two of them run together and you want to read one. Nothing is unloaded: the charts, the delta and the braking strip still have both laps.',
